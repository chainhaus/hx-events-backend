...
@Subselect("select " +
        ...
        "e.title as TITLE," +
        "(select count(*) from EVENT_ATTENDEE a join MAIL m on m.ATTENDEE_ID = a.ID and m.TYPE = 'RSVP' where a.EVENT_ID = e.ID and m.STATUS != 'SENT') as RSVP_QUEUED , " +
        ...
        "(select count(*) from EVENT_ATTENDEE a join MAIL m on m.ATTENDEE_ID = a.ID and m.TYPE = 'APPROVED' where a.EVENT_ID = e.ID and m.STATUS != 'SENT') as CONFIRMATION_QUEUED, " +
